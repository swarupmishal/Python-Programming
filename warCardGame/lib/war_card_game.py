class WarCardGame:
    ...
    @staticmethod
    def get_round_winner(player_card, computer_card):
    ...
    @staticmethod
    def get_cards_won(player_card, computer_card, previous_cards):
        if previous_cards:
    ...
    @staticmethod
    def add_cards_to_character(character, list_of_cards):
    ...
    def check_game_over(self):
        if self._player.has_empty_deck() or self._player.has_insufficient_cards():
            print("===================================================================")
            print("|                           GAME OVER                             |")
            print("===================================================================")
            print("Try again. The computer won!")
            return True
        elif self._computer.has_empty_deck() or self._computer.has_insufficient_cards():
            print("===================================================================")
            print("|                           GAME OVER                             |")
            print("===================================================================")
            print(f"Excelent. You won, {self._player.name}! Congratulations.")
            return True
        else:
            return False
